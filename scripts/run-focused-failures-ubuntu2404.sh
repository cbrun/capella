...
Examples:
  ...
  scripts/run-focused-failures-ubuntu2404.sh -- --only org.polarsys.capella.test.platform.ju.testcases.UIEnvironmentFingerprintTest --plugin org.polarsys.capella.test.platform.ju --ui
EOF
}
